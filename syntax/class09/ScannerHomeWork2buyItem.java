...
public class ScannerHomeWork2buyItem {

	public static void main(String[] args) {
		/*
		 *  Write a program to ask a user to tenter
		 ...
		 */
			...
			do {
				...
				if(totalAmount < price) {
					...
					System.out.println("You shoud give me this much more money:" + remainingBalance);
				}else if( totalAmount > price) {
					change = totalAmount -  price;
					System.out.println("Your change is "+ change);
				}else {
					System.out.println(" Man, You give me exactly what you owe me.");
				}
