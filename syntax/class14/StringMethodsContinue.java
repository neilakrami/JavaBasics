...
System.out.println("----- .contains() method --------");
	//chek is String contains another sequence of specified characters
...
System.out.println("--------- .endsWith() method -----------");
	...
	// drinks.starWith('w'); CE: we need to check if it starts with specified String , cannot be just char
...
System.out.println("------------ Real example of equals -----------------");
			...
			String expected = "Password cannot be emptu";
