...
public class Diploma {
	...
	public static void main(String[] args) {
		...
		//you should say congratulations, otherwise program 
		//should suggest to get a degree. Then if user has a degree 
		//program should check a gpa score. If gpa score is higher 
